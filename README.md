...
npm install
npm run dev
Open http://localhost:3000 → Open Control Room — Start Demo

One-click demo sequence
Open Control Room (/control-room)
Click Reset & replay finale (restores case-ananya-finale)
Inspect Traditional vs RE:WORK differentiator and What changed?
Open WHY? on any explainability report
Review pathway, proof-of-skill, opportunity viability, intervention simulator
Load negative case (B07) from the panel
Submit Human HR decision (AI recommendation preserved separately)
